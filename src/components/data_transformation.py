...
from sklearn.impute import SimpleImputer               #to check for missing values
...
class DataTransformationConfig:
    preprocessor_obj_file_path=os.path.join('traintestdata',"preprocessor.pkl")
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("Numerical columns atandard scaler completed"),
